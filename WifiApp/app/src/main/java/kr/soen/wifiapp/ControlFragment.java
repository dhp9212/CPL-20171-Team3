...
public class ControlFragment extends Fragment implements View.OnClickListener{
    ...
    Button lightBtn, hitterBtn, humBtn, motorBtn;
    Button lightBtnAuto, hitterBtnAuto, humBtnAuto, motorBtnPower;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        lightBtn = (Button)layout.findViewById(R.id.light_btn);
        lightBtn.setOnClickListener(this);
        if(lightState == 1)
        {
            lightBtn.setText("ON");
            lightBtn.setTextColor(getResources().getColor(R.color.colorAccent));
        }
        lightBtnAuto = (Button)layout.findViewById(R.id.light_btn_auto);
        ...
        hitterBtn = (Button)layout.findViewById(R.id.hitter_btn);
        hitterBtn.setOnClickListener(this);
        if(hitterState == 1)
        {
            hitterBtn.setText("ON");
            hitterBtn.setTextColor(getResources().getColor(R.color.colorAccent));
        }
        hitterBtnAuto = (Button)layout.findViewById(R.id.hitter_btn_auto);
        ...
        humBtn = (Button)layout.findViewById(R.id.hum_btn);
        humBtn.setOnClickListener(this);
        if(humState == 1)
        {
            humBtn.setText("ON");
            humBtn.setTextColor(getResources().getColor(R.color.colorAccent));
        }
        humBtnAuto = (Button)layout.findViewById(R.id.hum_btn_auto);
        ...
        motorBtn = (Button)layout.findViewById(R.id.motor_btn);
        motorBtn.setOnClickListener(this);
        if(motorState == 1)
        {
            motorBtn.setText("LEFT");
        }
        motorBtnPower = (Button)layout.findViewById(R.id.motor_btn_power);
                    ...
                    if(!pref.getString("id", "").equals(""))
                    {
                        ...
                        else
                        {
                            ...
                            if (result.equals("S"))
                            {
                                ...
                                lightBtn.setTextColor(getResources().getColor(R.color.gray));
                                lightState = 0;
                            }
                        }
                        break;
                ...
                if (wifiManager.isWifiEnabled())
                {
                    if(!pref.getString("id", "").equals(""))
                    {
                        ...
                        else
                        {
                            ...
                            if (result.equals("S"))
                            {
                                hitterBtn.setText("OFF");
                                hitterBtn.setTextColor(getResources().getColor(R.color.gray));
                                hitterState = 0;
                            }
                        }
                        break;
                ...
                if (wifiManager.isWifiEnabled())
                {
                    if(!pref.getString("id", "").equals(""))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                humBtn.setText("OFF");
                                humBtn.setTextColor(getResources().getColor(R.color.gray));
                                humState = 0;
                            }
                        }
                        break;
