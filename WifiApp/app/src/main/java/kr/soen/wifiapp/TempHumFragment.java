...
public class TempHumFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        TextView dummy = (TextView)layout.findViewById(R.id.dummy);
        ...
        accruetempChart.getAxisLeft().setAxisMaximum(32);
        accruetempChart.getAxisLeft().setAxisMinimum(15);
        accruetempChart.getXAxis().setPosition(XAxis.XAxisPosition.BOTTOM);
        accruetempChart.getXAxis().setTextSize(8);
    ...
    public void onResume() {
        ...
        {
            float[] hotzoneHourly_m = { 28.3F, 27.7F, 29.5F, 27.0F, 29.1F, 25.3F, 25.0F, 27.1F};
            float[] coolzoneHourly_m = { 23.1F, 18.7F, 20.4F, 20.7F, 22.1F, 17.9F, 18.6F, 17.0F, 17.5F};

            setData(27.5F, 17.5F, 57.7F, 52.5F);
            setGraphData(hotzoneHourly_m, coolzoneHourly_m);
        }
        else
        {
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            case R.id.btn_profile:
                ...
                break;
            case R.id.dummy:
                ((MainActivity)getActivity()).logMessege("내부환경이 적절치 않습니다.");
                break;
    ...
    public void setValue(String valueSet, int state)
    {
        ...
        if(state == TEMP_HUM)
        {
            for (int i = 0; i < countTokens; i++)
            {
                ...
                {
                    hum[i - 2] = Float.parseFloat(str.nextToken());
                }
            }
        }
    ...
    public void setData(float hotzone, float coolzone, float currenthum, float avghum)
    {
        hotzoneTemp.setText(Float.toString(hotzone));
        coolzoneTemp.setText(Float.toString(coolzone));
        currentHum.setText(Float.toString(currenthum));
        avgHum.setText(Float.toString(avghum));
    }
    ...
    public void setGraphData(float[] hotzone, float[] coolzone)
    {
        ...
        hotzoneDataSet.setValueTextSize(10);
        ...
        coolzoneDataSet.setValueTextSize(10);
